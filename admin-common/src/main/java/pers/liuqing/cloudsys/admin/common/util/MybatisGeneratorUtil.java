...
public class MybatisGeneratorUtil {
	...
	// biz模板路径
	private static String biz_vm = "/template/biz.vm";
    // Controller模板路径
	private static String controller2_vm = "/template/Controller2.vm";
	// list.html模板路径
	private static String list_vm = "/template/list.vm";
	// edit.html模板路径
	private static String edit_vm = "/template/edit.vm";
	// js模板路径
	private static String js_vm = "/template/js.vm";
	// list2.0
	private static String list2_vm = "/template/list2.vm";
	// edit2.0
	private static String edit2_vm = "/template/edit2.vm";
	// listjs2.0
	private static String listjs2_vm = "/template/listjs2.vm";
	// addjs2.0
	private static String addjs2_vm = "/template/addjs2.vm";
	/**
	...
	public static void generator(
			...
			String table_prefix,
			String package_name,
			Map<String, String> last_insert_id_tables,boolean is_table) throws Exception{
		...
		String targetProject =   "ace-" + module ;
	...
	//查询表中所有字段
	private static List<Map<String, Object>>  queryColumnByTableName(String table_name,String database_name,String jdbc_driver, String jdbc_url, String jdbc_username, String jdbc_password){
		JdbcUtil jdbcUtil = new JdbcUtil(jdbc_driver, jdbc_url, jdbc_username, jdbc_password);
		...
		for (Map map : result) {
			...
			column.put("column_name", map.get("COLUMN_NAME").toString().replace("_","").replace("-",""));
